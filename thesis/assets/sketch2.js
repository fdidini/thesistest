...
function DataDictionary(selectdata, selectarray, dict, wc, selectdiv, side) {
    ...
    function handleMouseOver(d, i) {
            ...
            //only on 1st side
            if (firstCheck.frequency >= .005 && secondCheck === undefined){
                ourdiv
                    .transition()
                    .style('opacity', '1')
                    .style('transform', 'scale(1.5)')
            ...
            else if (firstCheck.frequency >= .005 && secondCheck.frequency <= .005){
                ourdiv
                    .transition()
                    .style('opacity', '1')
                    .style('transform', 'scale(1.5)')
            ...
            //only on 2nd side
            else if (firstCheck === undefined && secondCheck.frequency >= .005) {
                ourdiv
                    .transition()
                    .style('opacity', '1')
                    .style('transform', 'scale(1.5)')
    ...
    function callBox(d, n, div){
        ...
        if (n===1){
            ...
            d3.select('#base1')
            .html('<p>On k12, ' + d[0].word + ' appears ' + round(d[0].frequency*100, 1) + '% times; on Github repos, the topic ' + d[1].word + ' appears ' + round(d[1].frequency*100, 1) + '% times</p>')
            ;
        } else if (n===3){
            d3.select('#base1')
            .html('<p>' + d.word + ': ' + round(d.frequency*100, 1) + '% times</p>')
