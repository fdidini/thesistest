...
function DataDictionary(typeFunc, selectdata, selectarray, dict, wc, selectdiv, side) {
    
    var cutoff = 0.0025;
    
    typeFunc(selectdata, function(error, data) {
...
DataDictionary(d3.json, 'data/completeStars.json', rawdata, dictionary1, wordCount, '#viz1', 'flex-start');
DataDictionary(d3.json, 'data/completeForks.json', rawdata2, dictionary2, wordCount2, '#viz2', 'flex-end');